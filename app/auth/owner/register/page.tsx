...
export default function Page() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
	...
	try {
	  const response = await api.post('web/registerowner', dataToSend);
  ...
  return (
	<>
					<div className="pb-5 w-full max-w-lg flex flex-col self-center">
						<h1 className="text-3xl font-semibold">Hi, Boss!</h1>
						<p className="text-white/50 text-xs">Sign Up untuk memulai mengelola reservasi anda.</p>
					</div>
