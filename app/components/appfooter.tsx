...
export default function AppFooter(){
	return (
	<>
		<footer className="bg-black pt-10 border-rose-950 border-t-1">
			<div className="mx-auto w-full max-w-screen-xl">
				<div className="md:flex md:justify-between">
				<div className="flex mb-8">
						<Link href=""><p className="text-white">Azzahra Cabin House</p></Link>
				</div>
				<div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
					<div>
						<h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Resources</h2>
						<ul className="text-rose-200 font-medium">
							<li className="mb-4">
					...
					<div>
						...
						<ul className="text-rose-200 font-medium">
							<li className="mb-4">
								<Link href="https://tailwindcss.com/" className="hover:underline">Github</Link>
							</li>
							<li>
								<Link href="https://tailwindcss.com/" className="hover:underline">Discord</Link>
							</li>
						</ul>
					</div>
					<div>
						...
						<ul className="text-rose-200 font-medium">
							<li className="mb-4">
								<Link href="https://tailwindcss.com/" className="hover:underline">Privacy Policy</Link>
							</li>
							<li>
								<Link href="https://tailwindcss.com/" className="hover:underline">Terms &amp; Conditions</Link>
							</li>
						</ul>
					</div>
				</div>
